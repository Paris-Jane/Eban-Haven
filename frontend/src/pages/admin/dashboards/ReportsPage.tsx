...
const moneyPhp = new Intl.NumberFormat(undefined, { style: 'currency', currency: 'PHP', maximumFractionDigits: 0 })
          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            ...
            <div className="grid gap-3 sm:grid-cols-3 xl:min-w-[34rem]">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/10 px-4 py-4 backdrop-blur-sm">
                ...
                <p className="mt-2 text-3xl font-bold">{formatCompactMoney(reports.totalMonetaryDonationsPhp)}</p>
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            {latestTrend ? (
              <div className="rounded-2xl border border-border bg-muted/30 px-4 py-3 text-right">
                ...
                <p className="mt-1 text-lg font-semibold text-foreground">{moneyPhp.format(latestTrend.monetaryTotalPhp)}</p>
                    ...
                    <div key={trend.month} className="flex min-w-0 flex-1 flex-col items-center gap-2">
                      <div className="relative flex h-full w-full items-end">
                        <div
                          ...
                          style={{ height }}
                          title={`${trend.month}: ${moneyPhp.format(trend.monetaryTotalPhp)}`}
                        />
                      </div>
